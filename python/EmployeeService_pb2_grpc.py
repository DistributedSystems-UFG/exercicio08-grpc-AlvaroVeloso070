...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListAllEmployees = channel.unary_unary(
                ...
                _registered_method=True)
        self.SearchEmployeeByName = channel.unary_unary(
                '/employee_service.EmployeeService/SearchEmployeeByName',
                request_serializer=EmployeeService__pb2.EmployeeNameSearch.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                _registered_method=True)
        self.UpdateEmployeeName = channel.unary_unary(
                ...
                response_deserializer=EmployeeService__pb2.StatusReply.FromString,
                _registered_method=True)
        self.GetEmployeeCount = channel.unary_unary(
                '/employee_service.EmployeeService/GetEmployeeCount',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeCount.FromString,
                _registered_method=True)
        self.ListEmployeesByTitle = channel.unary_unary(
                '/employee_service.EmployeeService/ListEmployeesByTitle',
                request_serializer=EmployeeService__pb2.EmployeeTitleFilter.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                _registered_method=True)
...
class EmployeeServiceServicer(object):
    ...
    def ListEmployeesByTitle(self, request, context):
        """List employees filtered by title
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SearchEmployeeByName': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchEmployeeByName,
                    request_deserializer=EmployeeService__pb2.EmployeeNameSearch.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
            ...
            'GetEmployeeCount': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeeCount,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeCount.SerializeToString,
            ),
            'ListEmployeesByTitle': grpc.unary_unary_rpc_method_handler(
                    servicer.ListEmployeesByTitle,
                    request_deserializer=EmployeeService__pb2.EmployeeTitleFilter.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
    }
...
class EmployeeService(object):
    ...
    def SearchEmployeeByName(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/employee_service.EmployeeService/SearchEmployeeByName',
            EmployeeService__pb2.EmployeeNameSearch.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def ListEmployeesByTitle(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/employee_service.EmployeeService/ListEmployeesByTitle',
            EmployeeService__pb2.EmployeeTitleFilter.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options,
            channel_credentials,
            insecure,
